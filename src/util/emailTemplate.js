				...
				<tr>
					<td style="font-size:0;background-color:#fcf5ef">
						...
						<table role="presentation" border="0" cellspacing="0" cellpadding="0" style="width:100%">
							...
							<tr>
								<td style="font-family:Arial,sans-serif;font-size:14px;color:#4e8991;padding:20px;font-weight:bold;text-align:center">
									<p style="margin:0">Please press on button below to verifiy your account</p>
								</td>
							</tr>
							<tr>
									...
									<table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin: auto;">
										<tr>
											<td style="background:#4e8991;text-align:center">
												...
												<strong>Verifiy My Account</strong>
												</a>
											</td>
										</tr>
									</table>
